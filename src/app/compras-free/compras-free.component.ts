...
import { CompraFreeService } from '../services/compra-free.service';

@Component({
    selector: 'app-compras-free',
    templateUrl: './compras-free.component.html',
    styleUrls: ['./compras-free.component.scss']
})
export class ComprasFreeComponent implements OnInit {
    ...
    public lottieConfigScan = {
        path: 'assets/animations/birthday.json',
        renderer: 'canvas',
        autoplay: true,
        loop: true,
    };
    ...
    constructor(
        ...
        public compraFreeProvider: CompraFreeService,
    ...
    completarPago() {
        ...
        this.loading = true;
        this.compraFreeProvider.post(compra).subscribe(r => {
            this.loading = false;
            this.cart = [];
