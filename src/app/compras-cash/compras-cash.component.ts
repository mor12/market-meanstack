import { CompraCashService } from './../services/compras-cash.service';
...
@Component({
    selector: 'app-compras-cash',
    templateUrl: './compras-cash.component.html',
    styleUrls: ['./compras-cash.component.scss']
})
export class ComprasCashComponent implements OnInit {
    ...
    constructor(
        ...
        public compracashProvider: CompraCashService,
