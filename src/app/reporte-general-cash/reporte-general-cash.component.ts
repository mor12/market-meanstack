...
@Component({
    selector: 'app-reporte-general-cash',
    templateUrl: './reporte-general-cash.component.html',
    styleUrls: ['./reporte-general-cash.component.scss']
})
export class ReporteGeneralCashComponent implements OnInit {
    ...
    constructor(
        ...
        reportProvider.getHistorialActualDateFilterCash(
            this.count,
            this.date_init,
            this.date_finish
        ).subscribe(r => {
    ...
    onScroll() {
        this.count += 10;
        this.reportProvider.getHistorialActualDateFilterCash(this.count,
            this.date_init,
    ...
    applyFilter() {
        if (this.date_finish_filter < this.date_init_filter) {
            ...
            this.reportProvider.getHistorialActualDateFilterCash(
                this.count,
                this.date_init,
                this.date_finish
            ).subscribe(r => {
